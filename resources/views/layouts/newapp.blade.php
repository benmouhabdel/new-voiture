        ...
        <div class="flex justify-between">
            ...
            <div class="flex space-x-7">
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <!-- Section Voitures -->
                    <div class="relative group z-40 my-5">
                        <a href="{{ route('cars.index') }}"
                           class="py-4 px-2 text-gray-500 hover:text-gray-900"
                            {{--@class([
                                 request()->routeIs('cars.*')=>'border-b-2 border-blue-500'
                            ])--}}
                        >
                            Voitures
                        </a>
                        <div class="absolute hidden group-hover:block w-48 bg-white shadow-lg py-2 mt-4">
                            <a href="{{ route('cars.index') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Liste
                                des voitures</a>
                            <a href="{{ route('cars.create') }}"
                               class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Ajouter une voiture</a>
                        </div>
                    </div>
