    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div id="animation-carousel" data-carousel="slide">
            <div class="relative h-[530px] overflow-hidden xl:h-[320px]">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div
                            class="overflow-hidden rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    <a href="#"
                                       class="text-xl font-semibold text-gray-900 hover:underline dark:text-white">Apple
                                        2024 10,9" iPad</a>
                                    ...
                                    <div class="mt-2 flex items-center gap-4">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <p class="ms-1 text-sm font-medium leading-none text-gray-500 dark:text-gray-400">
                                                (543 Reviews)</p>
                                        </div>
                                    </div>

                                    <form action="#"
                                          class="mt-4 flex justify-between gap-8 border-b border-t border-gray-200 py-4 dark:border-gray-700">
                                        <div>
                                            <label
                                                class="text-base font-medium leading-none text-gray-900 dark:text-white">Color</label>
                                            ...
                                            <div class="mt-2 flex items-center gap-2">
                                                ...
                                                <label
                                                    ...
                                                    <input type="radio" name="color-choice" value="Pink"
                                                           class="sr-only"/>
                                                ...
                                                <label
                                                    ...
                                                    <input type="radio" name="color-choice" value="Teal"
                                                           class="sr-only"/>
                                        ...
                                        <div class="mx-auto w-full">
                                            <label for="quantity-input"
                                                   class="text-base font-medium leading-none text-gray-900 dark:text-white">Qty:</label>
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-1"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-1" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    <a href="#"
                                       class="text-xl font-semibold text-gray-900 hover:underline dark:text-white">PlayStation®5
                                        Console – 1TB</a>
                                        ...
                                        <div class="mx-auto w-full">
                                            ...
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-2"
                                                        data-input-counter-decrement="quantity-input-2"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <button type="button" id="increment-button-2"
                                                        data-input-counter-increment="quantity-input-2"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-2"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-2" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                        ...
                                        <div class="mx-auto w-full">
                                            ...
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-3"
                                                        data-input-counter-decrement="quantity-input-3"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <button type="button" id="increment-button-3"
                                                        data-input-counter-increment="quantity-input-3"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-3"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-3" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    ...
                                    <form action="#"
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2 flex items-center gap-2">
                                                ...
                                                <label
                                                    class="relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 ring-gray-700 focus:outline-none has-[:checked]:ring-2">
                                                    <input type="radio" name="color-choice" value="Blue"
                                                           class="sr-only"/>
                                                    <span id="color-choice-13-label" class="sr-only"> Gray </span>
                                                    <span aria-hidden="true"
                                                          class="h-7 w-7 rounded-full border border-gray-600 border-opacity-10 bg-gray-600"></span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mx-auto w-full">
                                            ...
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-4"
                                                        data-input-counter-decrement="quantity-input-4"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <button type="button" id="increment-button-4"
                                                        data-input-counter-increment="quantity-input-4"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-4"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-4" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                        ...
                                        <div class="mx-auto w-full">
                                            ...
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-5"
                                                        data-input-counter-decrement="quantity-input-5"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <button type="button" id="increment-button-5"
                                                        data-input-counter-increment="quantity-input-5"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-5"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-5" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    ...
                                    <form action="#"
                                        ...
                                        <div class="mx-auto w-full">
                                            <label for="quantity-input"
                                                   class="text-base font-medium leading-none text-gray-900 dark:text-white">Qty:</label>
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-6"
                                                        data-input-counter-decrement="quantity-input-6"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                />
                                                <button type="button" id="increment-button-6"
                                                        data-input-counter-increment="quantity-input-6"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-6"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-6" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    ...
                                    <form action="#"
                                        ...
                                        <div class="mx-auto w-full">
                                            <label for="quantity-input"
                                                   class="text-base font-medium leading-none text-gray-900 dark:text-white">Qty:</label>
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-7"
                                                        data-input-counter-decrement="quantity-input-7"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                />
                                                <button type="button" id="increment-button-7"
                                                        data-input-counter-increment="quantity-input-7"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-7"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-7" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
                        ...
                        <div
                            ...
                            <div class="items-center lg:flex">
                                ...
                                <div class="flex-1 pt-4 lg:pl-6 lg:pt-0">
                                    ...
                                    <form action="#"
                                        ...
                                        <div class="mx-auto w-full">
                                            <label for="quantity-input"
                                                   class="text-base font-medium leading-none text-gray-900 dark:text-white">Qty:</label>
                                            <div class="relative mt-2 flex max-w-32 items-center">
                                                <button type="button" id="decrement-button-8"
                                                        data-input-counter-decrement="quantity-input-8"
                                                        class="h-10 rounded-s-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                />
                                                <button type="button" id="increment-button-8"
                                                        data-input-counter-increment="quantity-input-8"
                                                        class="h-10 rounded-e-lg border border-gray-300 bg-gray-100 p-3 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                                                    <svg class="h-3 w-3 text-gray-900 dark:text-white"
                                                         aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                         fill="none" viewBox="0 0 18 18">
                                    ...
                                    <div class="mt-4 flex items-center space-x-4">
                                        <button type="button" data-tooltip-target="carousel-tooltip-add-to-favorites-8"
                                                title=""
                                                class="flex items-center justify-center rounded-lg border border-gray-200 bg-white p-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
                                                role="button">
                                            <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div id="carousel-tooltip-add-to-favorites-8" role="tooltip"
                                             class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
                                             style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate3d(1240.5px, -239px, 0px);"
                                             data-popper-placement="top">
                                            Add to favorites
          ...
          <span class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            <svg aria-hidden="true" class="h-7 w-7" fill="currentColor" viewBox="0 0 20 20"
